...
- The new training dataset has 1000 tasks, it has almost all the previous ARC-AGI-1 tasks as shown in this [notebook](https://www.kaggle.com/code/ironbar/arc-agi-1-tasks-missing-in-arc-agi-2).
